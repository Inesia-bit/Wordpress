...
if ( ! function_exists( 'ghostpool_scripts' ) ) {
	...
	function ghostpool_scripts() {
		...
		'.gp-header-standard #gp-logo {padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_logo_dimensions', 'height' ) ) ) / 2 . 'px 0;}' . 

		'.gp-desktop-scrolling.gp-header-standard #gp-logo {padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_logo_dimensions', 'height' ) ) ) / 2 . 'px 0;}' . 

		'.gp-header-standard #gp-primary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_typography', 'line-height' ) ) + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}
		.gp-header-standard #gp-cart-button,.gp-header-standard #gp-search-button,.gp-header-standard #gp-profile-button{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - 18 ) / 2 . 'px 0;}' .

		'.gp-desktop-scrolling.gp-header-standard #gp-primary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_typography', 'line-height' ) ) + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}
		.gp-desktop-scrolling.gp-header-standard #gp-cart-button,.gp-desktop-scrolling.gp-header-standard #gp-search-button,.gp-desktop-scrolling.gp-header-standard #gp-profile-button{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - 18 ) / 2 . 'px 0;}' .
		...
		'.gp-header-centered #gp-cart-button,.gp-header-centered #gp-search-button,.gp-header-centered #gp-profile-button{line-height:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_typography', 'line-height' ) ) + 2 ) . 'px;}' .

		'.gp-header-standard #gp-secondary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height') ) - ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_typography', 'line-height' ) ) + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}' .

		'.gp-desktop-scrolling.gp-header-standard #gp-secondary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_typography', 'line-height' ) ) + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_link_border_hover', 'border-top' )  ) ) ) / 2 . 'px 0;}' .
		...
		'@media only screen and (max-width: 1082px) {' .
			...
			'.gp-header-standard #gp-primary-main-nav .menu > li > a {padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - ( 16 + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}' . 

			'.gp-desktop-scrolling.gp-header-standard #gp-primary-main-nav .menu > li > a {padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - ( 16 + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'primary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}' . 
		
			'.gp-header-standard #gp-cart-button,.gp-header-standard #gp-search-button,.gp-header-standard #gp-profile-button{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - 18 ) / 2 . 'px 0;}' .

			'.gp-desktop-scrolling.gp-header-standard #gp-cart-button,.gp-desktop-scrolling.gp-header-standard #gp-search-button,.gp-desktop-scrolling.gp-header-standard #gp-profile-button{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - 18 ) / 2 . 'px 0;}' .
		
			'.gp-header-standard #gp-secondary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_header_height', 'height' ) ) - ( 14 + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}' .

			'.gp-desktop-scrolling.gp-header-standard #gp-secondary-main-nav .menu > li > a{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'desktop_scrolling_header_height', 'height' ) ) - ( 14 + preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'secondary_nav_link_border_hover', 'border-top' ) ) ) ) / 2 . 'px 0;}' .
		...
		'@media only screen and (max-width: 1023px) {' .
			...
			'.gp-responsive #gp-logo {padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'mobile_header_height', 'height' ) ) - preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'mobile_logo_dimensions', 'height' ) ) ) / 2 . 'px 0;}' .
	
			'.gp-responsive #gp-mobile-nav-button,.gp-responsive #gp-cart-button,.gp-responsive #gp-search-button,.gp-responsive #gp-profile-button{padding:' . ( preg_replace( '/[^0-9]/', '', (int) ghostpool_option( 'mobile_header_height', 'height' ) ) - 18 ) / 2 . 'px 0;}' .
...
if ( ! function_exists( 'ghostpool_excerpt' ) ) {
	function ghostpool_excerpt( $length = 0 ) {
...
if ( ! function_exists( 'ghostpool_register_required_plugins' ) ) {
	...
	function ghostpool_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				'name'      		=> esc_html__( 'Envato Market', 'socialize' ),
				'slug'      		=> 'envato-market',
